...
public partial struct JVector
{
    ...
    public static implicit operator JVector(in Vector3 v) => new((Real)v.X, (Real)v.Y, (Real)v.Z);
}
...
public partial struct JQuaternion
{
    ...
    public static implicit operator JQuaternion(in Quaternion q) => new((Real)q.X, (Real)q.Y, (Real)q.Z, (Real)q.W);
}
