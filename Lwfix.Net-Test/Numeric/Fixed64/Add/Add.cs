...
namespace Test.Numerics
{
    ...
    public partial class TAdd64
    {
        ...
        {
            // 测试特殊值
            var zero = Fixed64.Zero;
            var one = Fixed64.One;
            var negativeOne = Fixed64.NegativeOne;
            var maxValue = Fixed64.MaxValue;
            var minValue = Fixed64.MinValue;
            var nan = Fixed64.NaN;
            var positiveInfinity = Fixed64.PositiveInfinity;
            var negativeInfinity = Fixed64.NegativeInfinity;
