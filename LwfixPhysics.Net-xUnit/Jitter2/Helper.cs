namespace SimplexLab.LwfixPhysics.Jitter2.Test;

/// <summary>
/// Shared helpers for building test scenes.
/// </summary>
public static class Helper
{
    ...
    {
        JQuaternion halfRotationStep = JQuaternion.CreateRotationY(Real.PI * (Real)(2.0 / 64.0));
        ...
        for (int e = 0; e < size; e++)
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                var shape = new BoxShape((Real)3, (Real)1, (Real)0.5);
