 ...
 * guard value in DynamicTree has been adjusted for Fixed32's reduced range.
 */
...
[StructLayout(LayoutKind.Explicit, Size = 8 * Precision.RealSize)]
public struct TreeBox : IEquatable<TreeBox>
{
    /// <summary>
    /// Small epsilon value used for ray-box intersection tests.
    /// </summary>
    public static readonly Real Epsilon = Fixed32.Epsilon;

    /// <summary>The minimum corner of the bounding box.</summary>
    [FieldOffset(0 * Precision.RealSize)] public JVector Min;

    /// <summary>Padding for SIMD alignment. Not used directly.</summary>
    [FieldOffset(3 * Precision.RealSize)] public Real MinW;

    /// <summary>The maximum corner of the bounding box.</summary>
    [FieldOffset(4 * Precision.RealSize)] public JVector Max;

    /// <summary>Padding for SIMD alignment. Not used directly.</summary>
    [FieldOffset(7 * Precision.RealSize)] public Real MaxW;
    ...
    public readonly Real GetSurfaceArea()
    {
        ...
        Real ex = extent.GetElement(0);
        Real ey = extent.GetElement(1);
        Real ez = extent.GetElement(2);

        return (Real)2.0 * (ex * ey + ey * ez + ez * ex);
    }
