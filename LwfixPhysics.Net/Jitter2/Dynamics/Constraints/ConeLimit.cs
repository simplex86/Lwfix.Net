...
public unsafe class ConeLimit : Constraint<ConeLimit.ConeLimitData>
{
    ...
    public void Initialize(JVector axisBody1, JVector axisBody2, AngularLimit limit)
    {
        ...
        ArgumentCheck.InRange((Real)limit.From, (Real)0.0, Fixed32.PI, nameof(limit.From));
        ArgumentCheck.InRange((Real)limit.To, (Real)limit.From, Fixed32.PI, nameof(limit.To));
    ...
    public AngularLimit Limit
    {
        ...
        set
        {
            ArgumentCheck.InRange((Real)value.From, (Real)0.0, Fixed32.PI, nameof(value.From));
