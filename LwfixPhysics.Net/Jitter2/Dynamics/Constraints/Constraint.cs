...
namespace SimplexLab.LwfixPhysics.Jitter2.Dynamics.Constraints;
...
public abstract class Constraint : IDebugDrawable
{
    ...
    public static readonly Real DefaultAngularSoftness = (Real)0.001;

    /// <summary>Default bias factor for angular error correction.</summary>
    public static readonly Real DefaultAngularBias = (Real)0.2;

    /// <summary>Default softness for angular limit enforcement.</summary>
    public static readonly Real DefaultAngularLimitSoftness = (Real)0.001;

    /// <summary>Default bias factor for angular limit correction.</summary>
    public static readonly Real DefaultAngularLimitBias = (Real)0.1;

    /// <summary>Default softness (compliance) for linear constraints.</summary>
    public static readonly Real DefaultLinearSoftness = (Real)0.00001;

    /// <summary>Default bias factor for linear error correction.</summary>
    public static readonly Real DefaultLinearBias = (Real)0.2;

    /// <summary>Default softness for linear limit enforcement.</summary>
    public static readonly Real DefaultLinearLimitSoftness = (Real)0.0001;

    /// <summary>Default bias factor for linear limit correction.</summary>
    public static readonly Real DefaultLinearLimitBias = (Real)0.2;
