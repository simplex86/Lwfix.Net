...
using SimplexLab.LwfixPhysics.Jitter2.Unmanaged;

namespace SimplexLab.LwfixPhysics.Jitter2.Dynamics;
...
#pragma warning restore CS0649
    ...
    public struct Contact
    {
        ...
        [FieldOffset(4 + 1 * Precision.RealSize)] public Real PenaltyBias;

        // ―――――― The following 4-component vectors overlap ――――――――――――――――――――――――――――――

        [FieldOffset(4 + 2 * Precision.RealSize)] internal VectorReal NormalTangentX;

        [FieldOffset(4 + 5 * Precision.RealSize)] internal VectorReal NormalTangentY;

        [FieldOffset(4 + 8 * Precision.RealSize)] internal VectorReal NormalTangentZ;

        [FieldOffset(4 + 11 * Precision.RealSize)] internal VectorReal MassNormalTangent;

        [FieldOffset(4 + 14 * Precision.RealSize)] internal VectorReal Accumulated;

        [FieldOffset(4 + 18 * Precision.RealSize)] [ReferenceFrame(ReferenceFrame.Local)]
        internal JVector Position1;

        [FieldOffset(4 + 21 * Precision.RealSize)] [ReferenceFrame(ReferenceFrame.Local)]
        internal JVector Position2;

        /// <summary>
        /// Position of the contact relative to the center of mass on the first body.
        /// </summary>
        [FieldOffset(4+25*Precision.RealSize)]
        ...
        /// </summary>
        [FieldOffset(4+28*Precision.RealSize)]
        ...
        {
            Debug.Assert(MathR.Abs(n.LengthSquared() - (Real)1.0) < (Real)1e-3);
        ...
        internal unsafe void PrepareForIteration(ContactData* cd, Real idt)
        {
            ...
            Unsafe.As<VectorReal, JVector>(ref MassNormalTangent) = mass;

            PenaltyBias = BiasFactor * idt * MathR.Max((Real)0.0, penetration - AllowedPenetration);
        ...
        internal unsafe void PrepareForIterationAccelerated(ContactData* cd, Real idt)
        {
            ...
            Unsafe.As<VectorReal, JVector>(ref MassNormalTangent) = Unsafe.As<VectorReal, JVector>(ref mnt);
