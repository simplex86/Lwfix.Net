...
public struct RigidBodyData
{
    ...
    /// </summary>
    [FieldOffset(8 + 0*Precision.RealSize)]
    public JVector Position;

    /// <summary>
    /// Linear velocity in world space, measured in units per second.
    /// </summary>
    [FieldOffset(8 + 3*Precision.RealSize)]
    ...
    /// </summary>
    [FieldOffset(8 + 6*Precision.RealSize)]
    ...
    /// Internal use only.
    /// </summary>
    [FieldOffset(8 + 9*Precision.RealSize)]
    ...
    /// </summary>
    [FieldOffset(8 + 19*Precision.RealSize)]
    ...
    /// </summary>
    [FieldOffset(8 + 28*Precision.RealSize)]
    ...
    /// </summary>
    [FieldOffset(8 + 29*Precision.RealSize)]
    public int Flags;
...
public sealed class RigidBody : IPartitionedSetIndex, IDebugDrawable
{
    ...
    {
        get => TimeSpan.FromSeconds((double)deactivationTimeThreshold);
        set
        {
