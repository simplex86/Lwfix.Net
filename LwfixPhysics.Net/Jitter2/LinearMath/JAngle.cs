...
/// </summary>
[StructLayout(LayoutKind.Explicit, Size = 1*Precision.RealSize)]
public struct JAngle : IEquatable<JAngle>
{
    /// <summary>
    /// Gets or sets the angle value in radians.
    /// </summary>
    [field: FieldOffset(0*Precision.RealSize)]
    ...
    public Real Degree
    {
        readonly get => Radian / Fixed32.PI * (Real)180.0;
        set => Radian = value / (Real)180.0 * Fixed32.PI;
    }
