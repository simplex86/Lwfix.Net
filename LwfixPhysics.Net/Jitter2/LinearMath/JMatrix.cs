...
/// </summary>
[StructLayout(LayoutKind.Explicit, Size = 9 * Precision.RealSize)]
public struct JMatrix(
    Real m11, Real m12, Real m13,
    Real m21, Real m22, Real m23,
    Real m31, Real m32, Real m33) : IEquatable<JMatrix>
{
    [FieldOffset(0 * Precision.RealSize)] public Real M11 = m11;
    [FieldOffset(1 * Precision.RealSize)] public Real M21 = m21;
    [FieldOffset(2 * Precision.RealSize)] public Real M31 = m31;
    [FieldOffset(3 * Precision.RealSize)] public Real M12 = m12;
    [FieldOffset(4 * Precision.RealSize)] public Real M22 = m22;
    [FieldOffset(5 * Precision.RealSize)] public Real M32 = m32;
    [FieldOffset(6 * Precision.RealSize)] public Real M13 = m13;
    [FieldOffset(7 * Precision.RealSize)] public Real M23 = m23;
    [FieldOffset(8 * Precision.RealSize)] public Real M33 = m33;
    ...
    {
        (Real s, Real c) = MathR.SinCos(angle / (Real)2.0);
        axis *= s;
    ...
    public static JMatrix CreateRotationX(Real radians)
    {
        ...
        (Real s, Real c) = MathR.SinCos(radians);
    ...
    {
        result.M11 = MathR.Abs(matrix.M11);
        result.M12 = MathR.Abs(matrix.M12);
        result.M13 = MathR.Abs(matrix.M13);
        result.M21 = MathR.Abs(matrix.M21);
        result.M22 = MathR.Abs(matrix.M22);
        result.M23 = MathR.Abs(matrix.M23);
        result.M31 = MathR.Abs(matrix.M31);
        result.M32 = MathR.Abs(matrix.M32);
        result.M33 = MathR.Abs(matrix.M33);
    }
