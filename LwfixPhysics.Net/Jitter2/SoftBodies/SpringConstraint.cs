...
namespace SimplexLab.LwfixPhysics.Jitter2.SoftBodies;
...
public unsafe class SpringConstraint : Constraint<SpringConstraint.SpringData>
{
    ...
    public void SetSpringParameters(Real frequency, Real damping, Real dt)
    {
        ...
        Real omega = (Real)2.0 * Fixed32.PI * frequency;
    ...
    internal static void PrepareForIterationSpringConstraint(ref ConstraintData constraint, Real idt)
    {
        ...
        JVector n = p2 - p1;
        if (n.LengthSquared() > Fixed32.Epsilon) JVector.NormalizeInPlace(ref n);
