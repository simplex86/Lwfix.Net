...
namespace SimplexLab.LwfixPhysics.Jitter2.Unmanaged;
...
public static unsafe class MemoryHelper
{
    ...
    /// </remarks>
    [StructLayout(LayoutKind.Sequential, Size = 6 * Precision.RealSize)]
    ...
    /// The struct uses sequential layout and a fixed size to ensure consistent memory alignment and layout.
    /// </remarks>
    [StructLayout(LayoutKind.Sequential, Size = 9 * Precision.RealSize)]
    ...
    /// The struct uses sequential layout and a fixed size to ensure consistent memory alignment and layout.
    /// </remarks>
    [StructLayout(LayoutKind.Sequential, Size = 12 * Precision.RealSize)]
    ...
    /// The struct uses sequential layout and a fixed size to ensure consistent memory alignment and layout.
    /// </remarks>
    [StructLayout(LayoutKind.Sequential, Size = 16 * Precision.RealSize)]
