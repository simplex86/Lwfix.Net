...
using SimplexLab.LwfixPhysics.Jitter2.Collision;
using SimplexLab.LwfixPhysics.Jitter2.DataStructures;
using SimplexLab.LwfixPhysics.Jitter2.Dynamics;
using SimplexLab.LwfixPhysics.Jitter2.Dynamics.Constraints;
using SimplexLab.LwfixPhysics.Jitter2.Parallelization;
using SimplexLab.LwfixPhysics.Jitter2.Unmanaged;

namespace SimplexLab.LwfixPhysics.Jitter2;
...
{
    private SolveMode solveMode = SimplexLab.LwfixPhysics.Jitter2.SolveMode.Regular;

    /// <summary>
    /// The solver strategy used during <see cref="Step"/>. Defaults to <see cref="SimplexLab.LwfixPhysics.Jitter2.SolveMode.Regular"/>.
    /// <remarks> <see cref="SimplexLab.LwfixPhysics.Jitter2.SolveMode.Deterministic"/> can be significantly slower than
    /// <see cref="SimplexLab.LwfixPhysics.Jitter2.SolveMode.Regular"/>.</remarks>
    /// </summary>
    /// <exception cref="ArgumentOutOfRangeException">Thrown when an undefined <see cref="SimplexLab.LwfixPhysics.Jitter2.SolveMode"/>
