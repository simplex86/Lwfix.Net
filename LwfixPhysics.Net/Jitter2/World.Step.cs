...
using ThreadPool = SimplexLab.LwfixPhysics.Jitter2.Parallelization.ThreadPool;
    ...
    private void StepInternal(Real dt, bool multiThread)
    {
        ...
        try
        {
            ...
            for (int i = 0; i < substeps; i++)
            {
                ...
                if (SolveMode == SimplexLab.LwfixPhysics.Jitter2.SolveMode.Deterministic)
                {
