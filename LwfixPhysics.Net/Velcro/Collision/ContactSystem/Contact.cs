...
namespace SimplexLab.LwfixPhysics.Velcro.Collision.ContactSystem
{
    ...
    public class Contact
    {
        ...
        internal Fixed32 _toi;

        private ContactType _type;

        internal Fixed32 _friction;
        internal Fixed32 _restitution;
        internal Fixed32 _restitutionThreshold;

        internal Fixed32 _tangentSpeed;
        ...
        public Fixed32 RestitutionThreshold
        {
        ...
        internal void Update(ContactManager contactManager)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < _manifold.PointCount; ++i)
                {
                    ...
                    mp2.NormalImpulse = (Fixed32)0.0;
                    mp2.TangentImpulse = (Fixed32)0.0;
