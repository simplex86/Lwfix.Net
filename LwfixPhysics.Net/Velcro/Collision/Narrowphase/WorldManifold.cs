...
namespace SimplexLab.LwfixPhysics.Velcro.Collision.Narrowphase
{
    internal static class WorldManifold
    {
        ...
        /// </summary>
        public static void Initialize(ref Manifold manifold, ref Transform xfA, Fixed32 radiusA, ref Transform xfB, Fixed32 radiusB, out Vector2 normal, out FixedArray2<Vector2> points, out FixedArray2<Fixed32> separations)
        {
            normal = Vector2.Zero;
            points = new FixedArray2<Vector2>();
            separations = new FixedArray2<Fixed32>();
            ...
            switch (manifold.Type)
            {
                ...
                {
                    normal = new Vector2((Fixed32)1.0, (Fixed32)0.0);
                    ...
                    points.Value0 = (Fixed32)0.5 * (cA + cB);
