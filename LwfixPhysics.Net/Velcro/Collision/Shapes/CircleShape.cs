...
namespace SimplexLab.LwfixPhysics.Velcro.Collision.Shapes
{
    ...
    public class CircleShape : Shape
    {
        ...
        public CircleShape(Fixed32 radius, Fixed32 density, Vector2 position = default) : base(ShapeType.Circle, radius, density)
        {
            _position = position;
            ComputeProperties();
        }

        public CircleShape(Fixed32 density) : base(ShapeType.Circle, (Fixed32)0, density)
        {
            ComputeProperties();
        }
        ...
        private void ComputeMass()
        {
            ...
            Fixed32 area = MathConstants.Pi * _radius * _radius;
        ...
        private void ComputeInertia()
        {
            ...
            _massData._inertia = _massData._mass * ((Fixed32)0.5 * _radius * _radius + Vector2.Dot(_position, _position));
        }
