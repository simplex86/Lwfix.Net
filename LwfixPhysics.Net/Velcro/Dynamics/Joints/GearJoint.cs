...
namespace SimplexLab.LwfixPhysics.Velcro.Dynamics.Joints
{
    ...
    public class GearJoint : Joint
    {
        ...
        private Fixed32 _iA, _iB, _iC, _iD;
        ...
        private Fixed32 _JwA, _JwB, _JwC, _JwD;
        ...
        private Fixed32 _mA, _mB, _mC, _mD;
        private Fixed32 _mass;
        private Fixed32 _ratio;

        private Fixed32 _referenceAngleA;
        private Fixed32 _referenceAngleB;
        ...
        public GearJoint(GearJointDef def) : base(def)
        {
            ...
            Fixed32 coordinateA, coordinateB;
            ...
            Fixed32 aA = _bodyA._sweep.A;
            Transform xfC = _bodyC._xf;
            Fixed32 aC = _bodyC._sweep.A;
            ...
            Fixed32 aB = _bodyB._sweep.A;
            Transform xfD = _bodyD._xf;
            Fixed32 aD = _bodyD._sweep.A;
        ...
        public GearJoint(Body bodyA, Body bodyB, Joint jointA, Joint jointB, Fixed32 ratio = default) : base(bodyA, bodyB, JointType.Gear)
        {
            if (ratio == default)
                ratio = Fixed32.One;
        ...
        internal override void InitVelocityConstraints(ref SolverData data)
        {
            ...
            Fixed32 aC = data.Positions[_indexC].A;
            Vector2 vC = data.Velocities[_indexC].V;
            Fixed32 wC = data.Velocities[_indexC].W;

            Fixed32 aD = data.Positions[_indexD].A;
            Vector2 vD = data.Velocities[_indexD].V;
            Fixed32 wD = data.Velocities[_indexD].W;
            ...
            _mass = _mass > Fixed32.Zero ? (Fixed32)1.0 / _mass : Fixed32.Zero;
        ...
        internal override void SolveVelocityConstraints(ref SolverData data)
        {
            ...
            Fixed32 Cdot = Vector2.Dot(_JvAC, vA - vC) + Vector2.Dot(_JvBD, vB - vD);
        ...
        internal override bool SolvePositionConstraints(ref SolverData data)
        {
            ...
            Vector2 JvAC, JvBD;
            Fixed32 JwA, JwB, JwC, JwD;
            Fixed32 mass = Fixed32.Zero;
            ...
            Fixed32 C = (coordinateA + _ratio * coordinateB) - _constant;
