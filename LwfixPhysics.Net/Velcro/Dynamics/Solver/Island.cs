...
namespace SimplexLab.LwfixPhysics.Velcro.Dynamics.Solver
{
    ...
    {
        private Fixed32 _linTolSqr = Settings.LinearSleepTolerance * Settings.LinearSleepTolerance;
        private Fixed32 _angTolSqr = Settings.AngularSleepTolerance * Settings.AngularSleepTolerance;
        ...
        public void Solve(ref Profile profile, ref TimeStep step, ref Vector2 gravity, bool allowSleep)
        {
            ...
            for (int i = 0; i < _bodyCount; ++i)
            {
                ...
                Fixed32 a = b._sweep.A;
                Vector2 v = b._linearVelocity;
                Fixed32 w = b._angularVelocity;
                ...
                if (b.BodyType == BodyType.Dynamic)
                {
                    ...
                    // Taylor expansion:
                    // v2 = (1.0f - c * dt) * v1
                    v *= MathUtils.Clamp((Fixed32)1.0 - h * b.LinearDamping, Fixed32.Zero, (Fixed32)1.0);
                    w *= MathUtils.Clamp((Fixed32)1.0 - h * b.AngularDamping, Fixed32.Zero, (Fixed32)1.0);
                }
            ...
            if (allowSleep)
            {
                Fixed32 minSleepTime = MathConstants.MaxFloat;
                ...
                for (int i = 0; i < _bodyCount; ++i)
                {
                    ...
                    {
                        b.SleepTime = Fixed32.Zero;
                        minSleepTime = Fixed32.Zero;
                    }
                    else
                    {
                        b.SleepTime += h;
                        minSleepTime = Fixed32.Min(minSleepTime, b.SleepTime);
                    }
                }
