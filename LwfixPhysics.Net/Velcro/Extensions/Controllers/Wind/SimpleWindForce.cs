...
namespace SimplexLab.LwfixPhysics.Velcro.Extensions.Controllers.Wind
{
    ...
    public class SimpleWindForce : AbstractForceController
    {
        ...
        public Fixed32 Divergence { get; set; }
        ...
        public override void ApplyForce(Fixed32 dt, Fixed32 strength)
        {
            foreach (Body body in World.BodyList)
            {
                //TODO: Consider Force Type
                Fixed32 decayMultiplier = GetDecayMultiplier(body);
                ...
                if (decayMultiplier != 0)
                {
                    ...
                    if (Variation != 0)
                    {
                        Fixed32 strengthVariation = (Fixed32)Randomize.NextDouble() * MathHelper.Clamp(Variation, 0, 1);
