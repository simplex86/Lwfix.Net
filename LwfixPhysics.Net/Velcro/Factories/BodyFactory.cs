...
namespace SimplexLab.LwfixPhysics.Velcro.Factories
{
    ...
    {
        public static Body CreateBody(World world, Vector2 position = new Vector2(), Fixed32 rotation = default, BodyType bodyType = BodyType.Static, object userData = null)
        {
        ...
        public static Body CreateRectangle(World world, Fixed32 width, Fixed32 height, Fixed32 density, Vector2 position = new Vector2(), Fixed32 rotation = default, BodyType bodyType = BodyType.Static, object userData = null)
        {
            if (width <= 0)
        ...
        public static Body CreateCircle(World world, Fixed32 radius, Fixed32 density, Vector2 position = new Vector2(), BodyType bodyType = BodyType.Static, object userData = null)
        {
        ...
        public static Body CreateEllipse(World world, Fixed32 xRadius, Fixed32 yRadius, int edges, Fixed32 density, Vector2 position = new Vector2(), Fixed32 rotation = default, BodyType bodyType = BodyType.Static, object userData = null)
        {
            Body body = CreateBody(world, position, rotation, bodyType, userData);
        ...
        public static Body CreatePolygon(World world, Vertices vertices, Fixed32 density, Vector2 position = new Vector2(), Fixed32 rotation = default, BodyType bodyType = BodyType.Static, object userData = null)
        {
            Body body = CreateBody(world, position, rotation, bodyType, userData);
        ...
        public static Body CreateCompoundPolygon(World world, List<Vertices> list, Fixed32 density, Vector2 position = new Vector2(), Fixed32 rotation = default, BodyType bodyType = BodyType.Static, object userData = null)
        {
        ...
        public static Body CreateGear(World world, Fixed32 radius, int numberOfTeeth, Fixed32 tipPercentage, Fixed32 toothHeight, Fixed32 density, Vector2 position = new Vector2(), Fixed32 rotation = default, BodyType bodyType = BodyType.Static, object userData = null)
        {
        ...
        public static Body CreateCapsule(World world, Fixed32 height, Fixed32 topRadius, int topEdges, Fixed32 bottomRadius, int bottomEdges, Fixed32 density, Vector2 position = new Vector2(), Fixed32 rotation = default, BodyType bodyType = BodyType.Static, object userData = null)
        {
        ...
        public static Body CreateCapsule(World world, Fixed32 height, Fixed32 endRadius, Fixed32 density, Vector2 position = new Vector2(), Fixed32 rotation = default, BodyType bodyType = BodyType.Static, object userData = null)
        {
        ...
        public static Body CreateRoundedRectangle(World world, Fixed32 width, Fixed32 height, Fixed32 xRadius, Fixed32 yRadius, int segments, Fixed32 density, Vector2 position = new Vector2(), Fixed32 rotation = default, BodyType bodyType = BodyType.Static, object userData = null)
        {
        ...
        public static Body CreateLineArc(World world, Fixed32 radians, int sides, Fixed32 radius, bool closed = false, Vector2 position = new Vector2(), Fixed32 rotation = default, BodyType bodyType = BodyType.Static, object userData = null)
        {
            Body body = CreateBody(world, position, rotation, bodyType, userData);
        ...
        public static Body CreateSolidArc(World world, Fixed32 density, Fixed32 radians, int sides, Fixed32 radius, Vector2 position = new Vector2(), Fixed32 rotation = default, BodyType bodyType = BodyType.Static, object userData = null)
        {
            Body body = CreateBody(world, position, rotation, bodyType, userData);
        ...
        public static BreakableBody CreateBreakableBody(World world, Vertices vertices, Fixed32 density, Vector2 position = new Vector2(), Fixed32 rotation = default)
        {
        ...
        public static BreakableBody CreateBreakableBody(World world, IEnumerable<Shape> shapes, Vector2 position = new Vector2(), Fixed32 rotation = default)
        {
