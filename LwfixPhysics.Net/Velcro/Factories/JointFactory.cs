...
namespace SimplexLab.LwfixPhysics.Velcro.Factories
{
    ...
    public static class JointFactory
    {
        ...
        public static GearJoint CreateGearJoint(World world, Body bodyA, Body bodyB, Joint jointA, Joint jointB, Fixed32 ratio)
        {
        ...
        public static PulleyJoint CreatePulleyJoint(World world, Body bodyA, Body bodyB, Vector2 anchorA, Vector2 anchorB, Vector2 worldAnchorA, Vector2 worldAnchorB, Fixed32 ratio, bool useWorldCoordinates = false)
        {
