...
namespace SimplexLab.LwfixPhysics.Velcro.Primitives
{
    ...
    public struct Color : IEquatable<Color>
    {
        ...
        /// <summary>
        /// Constructs an RGBA color from a packed value. The value is a 32-bit unsigned integer, with R in the least
        /// significant octet.
        /// </summary>
        ...
        /// <summary>Constructs an RGBA color from the XYZ unit length components of a vector. Alpha value will be opaque.</summary>
        /// <param name="color">A <see cref="Vector3" /> representing color.</param>
        public Color(Vector3 color)
            : this((int)(color.X * 255), (int)(color.Y * 255), (int)(color.Z * 255)) { }

        /// <summary>Constructs an RGBA color from a <see cref="Color" /> and an alpha value.</summary>
        ...
        public Color(Color color, int alpha)
        {
            ...
            {
                uint clampedA = (uint)MathHelper.Clamp(alpha, byte.MinValue, byte.MaxValue);
        ...
        /// <summary>Constructs an RGBA color from color and alpha value.</summary>
        /// <param name="color">A <see cref="Color" /> for RGB values of new <see cref="Color" /> instance.</param>
        /// <param name="alpha">Alpha component value from 0.0f to 1.0f.</param>
        public Color(Color color, Fixed32 alpha) :
            this(color, (int)(alpha * 255)) { }

        /// <summary>Constructs an RGBA color from scalars representing red, green and blue values. Alpha value will be opaque.</summary>
        /// <param name="r">Red component value from 0.0f to 1.0f.</param>
        /// <param name="g">Green component value from 0.0f to 1.0f.</param>
        /// <param name="b">Blue component value from 0.0f to 1.0f.</param>
        public Color(Fixed32 r, Fixed32 g, Fixed32 b)
        ...
        /// <param name="b">Blue component value from 0.0f to 1.0f.</param>
        /// <param name="alpha">Alpha component value from 0.0f to 1.0f.</param>
        public Color(Fixed32 r, Fixed32 g, Fixed32 b, Fixed32 alpha)
        ...
        public Color(int r, int g, int b)
        {
            ...
            {
                uint clampedR = (uint)MathHelper.Clamp(r, byte.MinValue, byte.MaxValue);
                uint clampedG = (uint)MathHelper.Clamp(g, byte.MinValue, byte.MaxValue);
                uint clampedB = (uint)MathHelper.Clamp(b, byte.MinValue, byte.MaxValue);
        ...
        /// <summary>Constructs an RGBA color from scalars representing red, green, blue and alpha values.</summary>
        /// <remarks>This overload sets the values directly without clamping, and may therefore be faster than the other overloads.</remarks>
        /// <param name="r"></param>
        /// <param name="g"></param>
        /// <param name="b"></param>
        ...
        /// <summary>Compares whether two <see cref="Color" /> instances are equal.</summary>
        ...
        /// <summary>Compares whether two <see cref="Color" /> instances are not equal.</summary>
        ...
        /// <summary>Gets the hash code of this <see cref="Color" />.</summary>
        ...
        /// <summary>Compares whether current instance is equal to specified object.</summary>
        ...
        /// <summary>TransparentBlack color (R:0,G:0,B:0,A:0).</summary>
        ...
        public static Color Lerp(Color value1, Color value2, Fixed32 amount)
        {
        ...
        /// <summary><see cref="Color.Lerp" /> should be used instead of this function.</summary>
        /// <returns>Interpolated <see cref="Color" />.</returns>
        [Obsolete("Color.Lerp should be used instead of this function.")]
        public static Color LerpPrecise(Color value1, Color value2, Fixed32 amount)
        {
            amount = MathHelper.Clamp(amount, 0, 1);
            return new Color(
        ...
        /// <summary>Multiply <see cref="Color" /> by value.</summary>
        /// <param name="value">Source <see cref="Color" />.</param>
        /// <param name="scale">Multiplicator.</param>
        /// <returns>Multiplication result.</returns>
        public static Color Multiply(Color value, Fixed32 scale)
        {
        ...
        /// <param name="scale">Multiplicator.</param>
        /// <returns>Multiplication result.</returns>
        public static Color operator *(Color value, Fixed32 scale)
        {
            return new Color((int)(value.R * scale), (int)(value.G * scale), (int)(value.B * scale), (int)(value.A * scale));
        }

        public static Color operator *(Fixed32 scale, Color value)
        {
            return new Color((int)(value.R * scale), (int)(value.G * scale), (int)(value.B * scale), (int)(value.A * scale));
        }

        /// <summary>Gets a <see cref="Vector3" /> representation for this object.</summary>
        /// <returns>A <see cref="Vector3" /> representation for this object.</returns>
        public Vector3 ToVector3()
        {
            return new Vector3(R / (Fixed32)255.0, G / (Fixed32)255.0, B / (Fixed32)255.0);
        }
        ...
        /// <summary>
        /// Returns a <see cref="String" /> representation of this <see cref="Color" /> in the format: {R:[red] G:[green]
        /// B:[blue] A:[alpha]}
        /// </summary>
        ...
        /// <summary>Compares whether current instance is equal to specified <see cref="Color" />.</summary>
        ...
        /// <summary>Deconstruction method for <see cref="Color" />.</summary>
        /// <param name="r">Red component value from 0 to 255.</param>
        /// <param name="g">Green component value from 0 to 255.</param>
        /// <param name="b">Blue component value from 0 to 255.</param>
        ...
        /// <param name="g">Green component value from 0.0f to 1.0f.</param>
        /// <param name="b">Blue component value from 0.0f to 1.0f.</param>
        public void Deconstruct(out Fixed32 r, out Fixed32 g, out Fixed32 b)
        {
            r = R / (Fixed32)255.0;
            g = G / (Fixed32)255.0;
            b = B / (Fixed32)255.0;
        ...
        /// <summary>Deconstruction method for <see cref="Color" /> with Alpha.</summary>
        /// <param name="r">Red component value from 0 to 255.</param>
        /// <param name="g">Green component value from 0 to 255.</param>
        /// <param name="b">Blue component value from 0 to 255.</param>
        ...
        public void Deconstruct(out Fixed32 r, out Fixed32 g, out Fixed32 b, out Fixed32 a)
        {
            r = R / (Fixed32)255.0;
            g = G / (Fixed32)255.0;
            b = B / (Fixed32)255.0;
