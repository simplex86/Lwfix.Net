...
namespace SimplexLab.LwfixPhysics.Velcro.Primitives
{
    ...
    internal class CurveKey : IEquatable<CurveKey>, IComparable<CurveKey>
    {
        ...
        public CurveKey(Fixed32 position, Fixed32 value)
            : this(position, value, Fixed32.Zero, Fixed32.Zero, CurveContinuity.Smooth) { }
        ...
        public CurveKey(Fixed32 position, Fixed32 value, Fixed32 tangentIn, Fixed32 tangentOut)
        ...
        public CurveKey(Fixed32 position, Fixed32 value, Fixed32 tangentIn, Fixed32 tangentOut, CurveContinuity continuity)
        {
            Position = position;
            Value = value;
            TangentIn = tangentIn;
