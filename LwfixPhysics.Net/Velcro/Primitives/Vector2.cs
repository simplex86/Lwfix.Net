...
namespace SimplexLab.LwfixPhysics.Velcro.Primitives
{
    ...
    public struct Vector2 : IEquatable<Vector2>
    {
        ...
        public static Vector2 Zero { get; } = new Vector2(Fixed32.Zero, Fixed32.Zero);

        /// <summary>Returns a <see cref="Vector2" /> with components 1, 1.</summary>
        public static Vector2 One { get; } = new Vector2(Fixed32.One, Fixed32.One);

        /// <summary>Returns a <see cref="Vector2" /> with components 1, 0.</summary>
        public static Vector2 UnitX { get; } = new Vector2(Fixed32.One, Fixed32.Zero);

        /// <summary>Returns a <see cref="Vector2" /> with components 0, 1.</summary>
        public static Vector2 UnitY { get; } = new Vector2(Fixed32.Zero, Fixed32.One);
        ...
        /// <summary>Constructs a 2d vector with X and Y set to the same value.</summary>
        ...
        /// <summary>Subtracts a <see cref="Vector2" /> from a <see cref="Vector2" />.</summary>
        ...
        /// <summary>Divides the components of a <see cref="Vector2" /> by the components of another <see cref="Vector2" />.</summary>
        ...
        /// <summary>Divides the components of a <see cref="Vector2" /> by a scalar.</summary>
        /// <param name="value1">Source <see cref="Vector2" /> on the left of the div sign.</param>
        ...
        /// <summary>Compares whether two <see cref="Vector2" /> instances are equal.</summary>
        ...
        /// <summary>Compares whether two <see cref="Vector2" /> instances are not equal.</summary>
        ...
        /// <summary>
        /// Creates a new <see cref="Vector2" /> that contains the cartesian coordinates of a vector specified in
        ...
        public static Vector2 Barycentric(Vector2 value1, Vector2 value2, Vector2 value3, Fixed32 amount1, Fixed32 amount2)
        {
            return new Vector2(
        ...
        /// <summary>Creates a new <see cref="Vector2" /> that contains CatmullRom interpolation of the specified vectors.</summary>
        ...
        public static Vector2 CatmullRom(Vector2 value1, Vector2 value2, Vector2 value3, Vector2 value4, Fixed32 amount)
        {
            return new Vector2(
        ...
        /// <summary>
        /// Creates a new <see cref="Vector2" /> that contains members from another vector rounded towards positive
        /// infinity.
        /// </summary>
        ...
        public static Fixed32 Distance(Vector2 value1, Vector2 value2)
        {
            Fixed32 v1 = value1.X - value2.X, v2 = value1.Y - value2.Y;
            return Fixed32.Sqrt(v1 * v1 + v2 * v2);
        }
        ...
        {
            Fixed32 v1 = value1.X - value2.X, v2 = value1.Y - value2.Y;
            result = Fixed32.Sqrt(v1 * v1 + v2 * v2);
        }
        ...
        public static Fixed32 DistanceSquared(Vector2 value1, Vector2 value2)
        {
            Fixed32 v1 = value1.X - value2.X, v2 = value1.Y - value2.Y;
            return v1 * v1 + v2 * v2;
        }
        ...
        /// <returns>The result of dividing a vector by a scalar.</returns>
        public static Vector2 Divide(Vector2 value1, Fixed32 divider)
        {
            Fixed32 factor = Fixed32.One / divider;
            value1.X *= factor;
            value1.Y *= factor;
        ...
        public static Fixed32 Dot(Vector2 value1, Vector2 value2)
        {
            return value1.X * value2.X + value1.Y * value2.Y;
        }
        ...
        /// <summary>
        /// Creates a new <see cref="Vector2" /> that contains members from another vector rounded towards negative
        /// infinity.
        /// </summary>
        /// <param name="value">Source <see cref="Vector2" />.</param>
        /// <returns>The rounded <see cref="Vector2" />.</returns>
        ...
        /// <summary>Creates a new <see cref="Vector2" /> that contains hermite spline interpolation.</summary>
        ...
        public static Vector2 Hermite(Vector2 value1, Vector2 tangent1, Vector2 value2, Vector2 tangent2, Fixed32 amount)
        {
        ...
        /// <summary>Creates a new <see cref="Vector2" /> that contains linear interpolation of the specified vectors.</summary>
        /// <param name="value1">The first vector.</param>
        /// <param name="value2">The second vector.</param>
        /// <param name="amount">Weighting value(between 0.0 and 1.0).</param>
        /// <returns>The result of linear interpolation of the specified vectors.</returns>
        public static Vector2 Lerp(Vector2 value1, Vector2 value2, Fixed32 amount)
        {
            return new Vector2(
        ...
        /// <summary>
        /// Creates a new <see cref="Vector2" /> that contains linear interpolation of the specified vectors. Uses
        /// <see cref="MathHelper.LerpPrecise" /> on MathHelper for the interpolation. Less efficient but more precise compared to
        /// <see cref="Vector2.Lerp(Vector2, Vector2, float)" />. See remarks section of <see cref="MathHelper.LerpPrecise" /> on
        ...
        /// <param name="amount">Weighting value(between 0.0 and 1.0).</param>
        /// <returns>The result of linear interpolation of the specified vectors.</returns>
        public static Vector2 LerpPrecise(Vector2 value1, Vector2 value2, Fixed32 amount)
        {
            return new Vector2(
        ...
        /// Creates a new <see cref="Vector2" /> that contains linear interpolation of the specified vectors. Uses
        /// <see cref="MathHelper.LerpPrecise" /> on MathHelper for the interpolation. Less efficient but more precise compared to
        /// <see cref="Vector2.Lerp(ref Vector2, ref Vector2, float, out Vector2)" />. See remarks section of
        ...
        /// <param name="amount">Weighting value(between 0.0 and 1.0).</param>
        /// <param name="result">The result of linear interpolation of the specified vectors as an output parameter.</param>
        public static void LerpPrecise(ref Vector2 value1, ref Vector2 value2, Fixed32 amount, out Vector2 result)
        {
            result.X = MathHelper.LerpPrecise(value1.X, value2.X, amount);
            result.Y = MathHelper.LerpPrecise(value1.Y, value2.Y, amount);
        }

        /// <summary>Creates a new <see cref="Vector2" /> that contains a maximal values from the two vectors.</summary>
        /// <param name="value1">The first vector.</param>
        /// <param name="value2">The second vector.</param>
        ...
        /// <summary>Creates a new <see cref="Vector2" /> that contains a minimal values from the two vectors.</summary>
        /// <param name="value1">The first vector.</param>
        /// <param name="value2">The second vector.</param>
        ...
        /// <summary>Creates a new <see cref="Vector2" /> that contains a multiplication of two vectors.</summary>
        /// <param name="value1">Source <see cref="Vector2" />.</param>
        ...
        /// <summary>Creates a new <see cref="Vector2" /> that contains a multiplication of <see cref="Vector2" /> and a scalar.</summary>
        /// <param name="value1">Source <see cref="Vector2" />.</param>
        /// <param name="scaleFactor">Scalar value.</param>
        /// <returns>The result of the vector multiplication with a scalar.</returns>
        public static Vector2 Multiply(Vector2 value1, Fixed32 scaleFactor)
        {
        ...
        /// <summary>Creates a new <see cref="Vector2" /> that contains the specified vector inversion.</summary>
        /// <param name="value">Source <see cref="Vector2" />.</param>
        ...
        {
            Fixed32 val = Fixed32.One / Fixed32.Sqrt(X * X + Y * Y);
            X *= val;
            Y *= val;
        }

        /// <summary>Creates a new <see cref="Vector2" /> that contains a normalized values from another vector.</summary>
        /// <param name="value">Source <see cref="Vector2" />.</param>
        /// <returns>Unit vector.</returns>
        public static Vector2 Normalize(Vector2 value)
        {
            Fixed32 val = Fixed32.One / Fixed32.Sqrt(value.X * value.X + value.Y * value.Y);
            value.X *= val;
            value.Y *= val;
            return value;
        }
        ...
        /// <summary>Creates a new <see cref="Vector2" /> that contains reflect vector of the given vector and normal.</summary>
        ...
        {
            Vector2 result;
            Fixed32 val = Fixed32.Two * (vector.X * normal.X + vector.Y * normal.Y);
        ...
        /// <summary>
        /// Creates a new <see cref="Vector2" /> that contains members from another vector rounded to the nearest integer
        /// value.
        /// </summary>
        /// <param name="value">Source <see cref="Vector2" />.</param>
        /// <returns>The rounded <see cref="Vector2" />.</returns>
        ...
        /// <summary>Creates a new <see cref="Vector2" /> that contains cubic interpolation of the specified vectors.</summary>
        /// <param name="value1">Source <see cref="Vector2" />.</param>
        /// <param name="value2">Source <see cref="Vector2" />.</param>
        /// <param name="amount">Weighting value.</param>
        /// <returns>Cubic interpolation of the specified vectors.</returns>
        public static Vector2 SmoothStep(Vector2 value1, Vector2 value2, Fixed32 amount)
        {
            return new Vector2(
        ...
        /// <summary>Creates a new <see cref="Vector2" /> that contains subtraction of on <see cref="Vector2" /> from a another.</summary>
        /// <param name="value1">Source <see cref="Vector2" />.</param>
        /// <param name="value2">Source <see cref="Vector2" />.</param>
        ...
        internal static Vector2 Transform(Vector2 position, Matrix matrix)
        {
        ...
        internal static void Transform(ref Vector2 position, ref Matrix matrix, out Vector2 result)
        {
            Fixed32 x = position.X * matrix.M11 + position.Y * matrix.M21 + matrix.M41;
            Fixed32 y = position.X * matrix.M12 + position.Y * matrix.M22 + matrix.M42;
            result.X = x;
            result.Y = y;
        }

        /// <summary>
        /// Apply transformation on vectors within array of <see cref="Vector2" /> by the specified <see cref="Matrix" />
        ...
        internal static Vector2 TransformNormal(Vector2 normal, Matrix matrix)
        {
        ...
        internal static void TransformNormal(ref Vector2 normal, ref Matrix matrix, out Vector2 result)
        {
        ...
        /// <summary>
        /// Apply transformation on normals within array of <see cref="Vector2" /> by the specified <see cref="Matrix" />
        /// and places the results in an another array.
        /// </summary>
        /// <param name="sourceArray">Source array.</param>
        /// <param name="sourceIndex">The starting index of transformation in the source array.</param>
        ...
        internal static void TransformNormal(
            Vector2[] sourceArray,
            int sourceIndex,
            ref Matrix matrix,
            Vector2[] destinationArray,
        ...
        /// <summary>
        /// Apply transformation on all normals within array of <see cref="Vector2" /> by the specified
        /// <see cref="Matrix" /> and places the results in an another array.
        /// </summary>
        /// <param name="sourceArray">Source array.</param>
        /// <param name="matrix">The transformation <see cref="Matrix" />.</param>
        /// <param name="destinationArray">Destination array.</param>
        internal static void TransformNormal(Vector2[] sourceArray, ref Matrix matrix, Vector2[] destinationArray)
        {
            if (sourceArray == null)
                throw new ArgumentNullException(nameof(sourceArray));
            if (destinationArray == null)
