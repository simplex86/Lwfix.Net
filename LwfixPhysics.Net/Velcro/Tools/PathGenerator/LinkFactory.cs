...
namespace SimplexLab.LwfixPhysics.Velcro.Tools.PathGenerator
{
    public static class LinkFactory
    {
        ...
        /// </param>
        public static Path CreateChain(World world, Vector2 start, Vector2 end, Fixed32 linkWidth, Fixed32 linkHeight, int numberOfLinks, Fixed32 linkDensity, bool attachRopeJoint)
        {
