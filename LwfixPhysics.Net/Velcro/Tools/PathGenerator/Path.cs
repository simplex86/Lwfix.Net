...
namespace SimplexLab.LwfixPhysics.Velcro.Tools.PathGenerator
{
    ...
    public class Path
    {
        ...
        public Vertices GetVertices(int divisions)
        {
            ...
            Fixed32 timeStep = Fixed32.One / divisions;

            for (Fixed32 i = Fixed32.Zero; i < Fixed32.One; i += timeStep)
            {
        ...
        public Vector2 GetPosition(Fixed32 time)
        {
            Vector2 temp;
            ...
            if (Closed)
            {
                ...
                _deltaT = Fixed32.One / (ControlPoints.Count - 1);
                ...
                // relative time
                Fixed32 lt = (time - _deltaT * p) / _deltaT;
        ...
        public Vector2 GetPositionNormal(Fixed32 time)
        {
            Fixed32 offsetTime = time + (Fixed32)0.0001;
        ...
        public List<Vector3> SubdivideEvenly(int divisions)
        {
            ...
            Fixed32 length = GetLength();

            Fixed32 deltaLength = length / divisions + (Fixed32)0.001;
            Fixed32 t = Fixed32.Zero;
            ...
            while (deltaLength * Fixed32.Half >= Vector2.Distance(start, end))
            {
                end = GetPosition(t);
                t += (Fixed32)0.0001;
            ...
            for (int i = 1; i < divisions; i++)
            {
                ...
                Fixed32 angle = Fixed32.Atan2(normal.Y, normal.X);
