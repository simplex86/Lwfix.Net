...
namespace SimplexLab.LwfixPhysics.Velcro.Tools.PathGenerator
{
    ...
    public static class PathManager
    {
        ...
        /// <param name="subdivisions">The subdivisions.</param>
        public static void ConvertPathToPolygon(Path path, Body body, Fixed32 density, int subdivisions)
        {
            if (!path.Closed)
        ...
        public static void MoveBodyOnPath(Path path, Body body, Fixed32 time, Fixed32 strength, Fixed32 timeStep)
        {
