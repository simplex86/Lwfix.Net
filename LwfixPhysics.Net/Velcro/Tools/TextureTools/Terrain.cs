...
namespace SimplexLab.LwfixPhysics.Velcro.Tools.TextureTools
{
    ...
    public class Terrain
    {
        ...
        private Fixed32 _localHeight;

        private Fixed32 _localWidth;
        ...
        public Terrain(World world, Vector2 position, Fixed32 width, Fixed32 height)
        {
            World = world;
            Width = width;
            Height = height;
        ...
        public void Initialize()
        {
            ...
            _topLeft = new Vector2(Center.X - (Width * Fixed32.Half), Center.Y - (-Height * Fixed32.Half));
            ...
            _dirtyArea = new AABB(new Vector2(Fixed32.MaxValue, Fixed32.MaxValue), new Vector2(Fixed32.MinValue, Fixed32.MinValue));
        }
        ...
        {
            Fixed32 ax = gx * CellSize;
            Fixed32 ay = gy * CellSize;
            ...
            Vector2 scale = new Vector2(Fixed32.One / PointsPerUnit, Fixed32.One / -PointsPerUnit);
