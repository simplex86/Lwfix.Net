...
namespace SimplexLab.LwfixPhysics.Velcro.Tools.Triangulation.Seidel
{
    ...
    internal static class SeidelDecomposer
    {
        ...
        public static List<Vertices> ConvexPartition(Vertices vertices, Fixed32 sheer = default)
        {
        ...
        public static List<Vertices> ConvexPartitionTrapezoid(Vertices vertices, Fixed32 sheer = default)
        {
            List<Point> compatList = new List<Point>(vertices.Count);
