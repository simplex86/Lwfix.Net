...
using SimplexLab.LwfixPhysics.Velcro.Tools.ConvexHull.GiftWrap;
using SimplexLab.LwfixPhysics.Velcro.Tools.Triangulation.Bayazit;
using SimplexLab.LwfixPhysics.Velcro.Tools.Triangulation.Delaunay;
using SimplexLab.LwfixPhysics.Velcro.Tools.Triangulation.Earclip;
using SimplexLab.LwfixPhysics.Velcro.Tools.Triangulation.FlipCode;
using SimplexLab.LwfixPhysics.Velcro.Tools.Triangulation.Seidel;

namespace SimplexLab.LwfixPhysics.Velcro.Tools.Triangulation.TriangulationBase
{
    public static class Triangulate
    {
        public static List<Vertices> ConvexPartition(Vertices vertices, TriangulationAlgorithm algorithm, bool discardAndFixInvalid = true, Fixed32 tolerance = default)
        {
            if (vertices.Count <= 3)
