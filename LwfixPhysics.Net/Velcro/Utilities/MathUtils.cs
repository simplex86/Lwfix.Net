...
namespace SimplexLab.LwfixPhysics.Velcro.Utilities
{
    public static class MathUtils
    {
        ...
        public static Fixed32 Cross(ref Vector2 a, ref Vector2 b)
        {
            return a.X * b.Y - a.Y * b.X;
        }

        /// <summary>Perform the cross product on two vectors.</summary>
        public static Fixed32 Cross(Vector2 a, Vector2 b)
        {
        ...
        /// <summary>Perform the cross product on two vectors.</summary>
        public static Vector2 Cross(Vector2 a, Fixed32 s)
        {
            return new Vector2(s * a.Y, -s * a.X);
        }

        /// <summary>Perform the cross product on two vectors.</summary>
        public static Vector2 Cross(Fixed32 s, Vector2 a)
        {
            return new Vector2(-s * a.Y, s * a.X);
        }
        ...
        {
            return new Vector2(FMath.Abs(v.X), FMath.Abs(v.Y));
        }
        ...
        {
            Fixed32 x = T.q.c * v.X - T.q.s * v.Y + T.p.X;
            Fixed32 y = T.q.s * v.X + T.q.c * v.Y + T.p.Y;
        ...
        {
            Fixed32 px = v.X - T.p.X;
            Fixed32 py = v.Y - T.p.Y;
            Fixed32 x = T.q.c * px + T.q.s * py;
            Fixed32 y = -T.q.s * px + T.q.c * py;
        ...
        public static bool IsValid(Fixed32 x)
        {
            if (x.IsNaN())
                return false;
        ...
        public static void Cross(ref Vector2 a, ref Vector2 b, out Fixed32 c)
        {
            c = a.X * b.Y - a.Y * b.X;
        }
        ...
        /// </summary>
        public static Fixed32 VectorAngle(ref Vector2 p1, ref Vector2 p2)
        {
            Fixed32 theta1 = Fixed32.Atan2(p1.Y, p1.X);
            Fixed32 theta2 = Fixed32.Atan2(p2.Y, p2.X);
            Fixed32 dtheta = theta2 - theta1;
        ...
        public static Fixed32 Dot(Vector3 a, Vector3 b)
        {
            return a.X * b.X + a.Y * b.Y + a.Z * b.Z;
        }

        /// <summary>Perform the dot product on two vectors.</summary>
        public static Fixed32 Dot(ref Vector2 a, ref Vector2 b)
        {
            return a.X * b.X + a.Y * b.Y;
        }

        /// <summary>Perform the dot product on two vectors.</summary>
        public static Fixed32 Dot(Vector2 a, Vector2 b)
        {
            return a.X * b.X + a.Y * b.Y;
        }

        public static Fixed32 VectorAngle(Vector2 p1, Vector2 p2)
        {
        ...
        public static Fixed32 Area(Vector2 a, Vector2 b, Vector2 c)
        {
        ...
        /// <summary>Returns a positive number if c is to the left of the line going from a to b.</summary>
        /// <returns>Positive number if point is left, negative if point is right, and 0 if points are collinear.</returns>
        public static Fixed32 Area(ref Vector2 a, ref Vector2 b, ref Vector2 c)
        {
            return a.X * (b.Y - c.Y) + b.X * (c.Y - a.Y) + c.X * (a.Y - b.Y);
        }

        /// <summary>Determines if three vertices are collinear (ie. on a straight line)</summary>
        public static bool IsCollinear(ref Vector2 a, ref Vector2 b, ref Vector2 c, Fixed32 tolerance = default)
        {
            return FloatInRange(Area(ref a, ref b, ref c), -tolerance, tolerance);
        }

        public static void Cross(Fixed32 s, ref Vector2 a, out Vector2 b)
        {
            b = new Vector2(-s * a.Y, s * a.X);
        }

        public static bool FloatEquals(Fixed32 value1, Fixed32 value2)
        {
            return FMath.Abs(value1 - value2) <= MathConstants.Epsilon;
        }

        /// <summary>Checks if a floating point Value is equal to another, within a certain tolerance.</summary>
        /// <returns>True if the values are "equal", false otherwise.</returns>
        public static bool FloatEquals(Fixed32 value1, Fixed32 value2, Fixed32 delta)
        {
        ...
        public static bool FloatInRange(Fixed32 value, Fixed32 min, Fixed32 max)
        {
        ...
        public static Fixed32 Distance(Vector2 a, Vector2 b)
        {
            Vector2 c = a - b;
            return c.Length();
        }

        public static Fixed32 Distance(ref Vector2 a, ref Vector2 b)
        {
            Vector2 c = a - b;
            return c.Length();
        }

        public static Fixed32 DistanceSquared(ref Vector2 a, ref Vector2 b)
        {
            Vector2 c = a - b;
            return Dot(ref c, ref c);
        }

        public static Fixed32 Max(Fixed32 valueA, Fixed32 valueB)
        {
            return Fixed32.Max(valueA, valueB);
        }
        ...
        public static Fixed32 Min(Fixed32 valueA, Fixed32 valueB)
        {
            return Fixed32.Min(valueA, valueB);
        }
        ...
        /// </summary>
        public static Fixed32 Normalize(ref Vector2 v)
        {
            Fixed32 length = v.Length();
            if (length < MathConstants.Epsilon)
            {
                return Fixed32.Zero;
            }
            Fixed32 invLength = (Fixed32)1.0 / length;
            v.X *= invLength;
            v.Y *= invLength;
        ...
        public static Fixed32 Cosf(Fixed32 value)
        {
            return Fixed32.Cos(value);
        }

        public static Fixed32 Sinf(Fixed32 value)
        {
            return Fixed32.Sin(value);
        }

        public static Fixed32 Ceil(Fixed32 log)
        {
            return FMath.Ceil(log);
        }

        public static Fixed32 Log(Fixed32 log)
        {
            return FMath.Log(log);
        }
    }
}
