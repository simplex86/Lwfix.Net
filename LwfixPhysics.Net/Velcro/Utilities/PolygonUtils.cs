...
using SimplexLab.LwfixPhysics.Velcro.Tools.TextureTools;
...
namespace SimplexLab.LwfixPhysics.Velcro.Utilities
{
    public static class PolygonUtils
    {
        ...
        public static Vertices CreateRectangle(Fixed32 hx, Fixed32 hy)
        {
        ...
        public static Vertices CreateRectangle(Fixed32 hx, Fixed32 hy, Vector2 center, Fixed32 angle)
        {
        ...
        /// <returns></returns>
        public static Vertices CreateRoundedRectangle(Fixed32 width, Fixed32 height, Fixed32 xRadius, Fixed32 yRadius, int segments)
        {
            ...
            if (segments == 0)
            {
                vertices.Add(new Vector2(width * (Fixed32)0.5 - xRadius, -height * (Fixed32)0.5));
                vertices.Add(new Vector2(width * (Fixed32)0.5, -height * (Fixed32)0.5 + yRadius));
            ...
            else
            {
                ...
                Fixed32 stepSize = MathConstants.TwoPi / (numberOfEdges - 4);
                ...
                for (int i = 1; i < numberOfEdges; i++)
                {
                    ...
                    vertices.Add(posOffset + new Vector2(xRadius * Fixed32.Cos(stepSize * -(i + phase)),
                        -yRadius * Fixed32.Sin(stepSize * -(i + phase))));
                }
            }
        ...
        /// <returns></returns>
        public static Vertices CreateCircle(Fixed32 radius, int numberOfEdges)
        {
        ...
        /// <returns></returns>
        public static Vertices CreateEllipse(Fixed32 xRadius, Fixed32 yRadius, int numberOfEdges)
        {
            Vertices vertices = new Vertices();

            Fixed32 stepSize = MathConstants.TwoPi / numberOfEdges;

            vertices.Add(new Vector2(xRadius, 0));
            for (int i = numberOfEdges - 1; i > 0; --i)
            {
                vertices.Add(new Vector2(xRadius * Fixed32.Cos(stepSize * i),
                    -yRadius * Fixed32.Sin(stepSize * i)));
            }

            return vertices;
        }

        public static Vertices CreateArc(Fixed32 radians, int sides, Fixed32 radius)
        {
            ...
            Fixed32 stepSize = radians / sides;
            for (int i = sides - 1; i > 0; i--)
            {
                vertices.Add(new Vector2(radius * Fixed32.Cos(stepSize * i),
                    radius * Fixed32.Sin(stepSize * i)));
            }
        ...
        /// <returns></returns>
        public static Vertices CreateCapsule(Fixed32 height, Fixed32 endRadius, int edges)
        {
        ...
        /// <returns></returns>
        public static Vertices CreateCapsule(Fixed32 height, Fixed32 topRadius, int topEdges, Fixed32 bottomRadius, int bottomEdges)
        {
            if (height <= 0)
            ...
            Fixed32 newHeight = (height - topRadius - bottomRadius) * (Fixed32)0.5;

            // top
            vertices.Add(new Vector2(topRadius, newHeight));

            Fixed32 stepSize = MathConstants.Pi / topEdges;
            for (int i = 1; i < topEdges; i++)
            {
                vertices.Add(new Vector2(topRadius * Fixed32.Cos(stepSize * i),
                    topRadius * Fixed32.Sin(stepSize * i) + newHeight));
            }
            ...
            {
                vertices.Add(new Vector2(-bottomRadius * Fixed32.Cos(stepSize * i),
                    -bottomRadius * Fixed32.Sin(stepSize * i) - newHeight));
            }
        ...
        public static Vertices CreateGear(Fixed32 radius, int numberOfTeeth, Fixed32 tipPercentage, Fixed32 toothHeight)
        {
            Vertices vertices = new Vertices();

            Fixed32 stepSize = MathConstants.TwoPi / numberOfTeeth;
            tipPercentage /= (Fixed32)100.0;
            MathHelper.Clamp(tipPercentage, Fixed32.Zero, (Fixed32)1.0);
            Fixed32 toothTipStepSize = (stepSize / (Fixed32)2.0) * tipPercentage;

            Fixed32 toothAngleStepSize = (stepSize - (toothTipStepSize * (Fixed32)2.0)) / (Fixed32)2.0;

            for (int i = numberOfTeeth - 1; i >= 0; --i)
            {
                if (toothTipStepSize > Fixed32.Zero)
                {
                    vertices.Add(
                        new Vector2(radius *
                                    Fixed32.Cos(stepSize * i + toothAngleStepSize * (Fixed32)2.0 + toothTipStepSize),
                            -radius *
                            Fixed32.Sin(stepSize * i + toothAngleStepSize * (Fixed32)2.0 + toothTipStepSize)));

                    vertices.Add(
                        new Vector2((radius + toothHeight) *
                                    Fixed32.Cos(stepSize * i + toothAngleStepSize + toothTipStepSize),
                            -(radius + toothHeight) *
                            Fixed32.Sin(stepSize * i + toothAngleStepSize + toothTipStepSize)));
                }

                vertices.Add(new Vector2((radius + toothHeight) *
                                         Fixed32.Cos(stepSize * i + toothAngleStepSize),
                    -(radius + toothHeight) *
                    Fixed32.Sin(stepSize * i + toothAngleStepSize)));
        ...
        /// <param name="holeDetection">if set to <c>true</c> it will perform hole detection.</param>
        /// <returns></returns>
        public static List<Vertices> CreatePolygon(uint[] data, int width, Fixed32 hullTolerance, byte alphaTolerance, bool multiPartDetection, bool holeDetection)
        {
